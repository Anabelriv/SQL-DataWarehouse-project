...
BEGIN
    BEGIN
        ...
        RAISE NOTICE '>> crm_cust_info load duration: % seconds', EXTRACT(SECOND FROM end_time - start_time);
        ...
        end_time := clock_timestamp();
        RAISE NOTICE '>> crm_prd_info load duration: % seconds', EXTRACT(SECOND FROM end_time - start_time);
        ...
        end_time := clock_timestamp();
        RAISE NOTICE '>> crm_sales_details load duration: % seconds', EXTRACT(SECOND FROM end_time - start_time);
        ...
        end_time := clock_timestamp();
        RAISE NOTICE '>> erp_cust_az12 load duration: % seconds', EXTRACT(SECOND FROM end_time - start_time);
        ...
        end_time := clock_timestamp();
        RAISE NOTICE '>> erp_loc_a101 load duration: % seconds', EXTRACT(SECOND FROM end_time - start_time);
        ...
        end_time := clock_timestamp();
        RAISE NOTICE '>> erp_px_cat_g1v2 load duration: % seconds', EXTRACT(SECOND FROM end_time - start_time);

        -- Print batch loading time
        batch_end_time := clock_timestamp();
        RAISE NOTICE 'Full loading time: % seconds', EXTRACT(SECOND FROM batch_end_time - batch_start_time);
